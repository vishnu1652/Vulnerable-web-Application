    ...
    <div class="container">
      ...
      <nav class="nav-menu  float-right  d-lg-block">
        ...
        <ul>
          ...
          <li class="active"> <a  href="signup.php" >Sign Up
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8">
          ...
          <div class="mb-3">
			    ...
			    <input type="text" class="form-control"  aria-describedby="emailHelp" name="mail" placeholder="Email">
        ...
        <div class="mb-3">
          ...
          <input type="password" class="form-control" name="cpwd" placeholder="confirm your password">
        </div>
